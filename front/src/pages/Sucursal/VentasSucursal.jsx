...
function VentasSucursal() {
    ...
    useEffect(() => {
        ...
        const fetchVentas = async () => {
            if (ventas === "anual") {
                try {
                    const res = await axios.get(`http://localhost:3001/api/sucursal/ventas-anuales/${user.idPyme}`);
                ...
                try {
                    const res = await axios.get(`http://localhost:3001/api/sucursal/ventas-mensuales/${user.idPyme}`);
                ...
                try {
                    const res = await axios.get(`http://localhost:3001/api/sucursal/ventas-semanales/${user.idPyme}`);
